"""
Tool registry and built-in tools for Step 07 - CUDA Agent.

Based on Step 06 with one key change: the workspace root is configurable
via set_workspace_root() so all file/shell operations target the CUDA task
working directory instead of the project parent.
"""
