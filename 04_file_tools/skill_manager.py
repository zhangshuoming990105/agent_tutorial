...
Skills are defined in skills/*/SKILL.md with frontmatter:
---
name: filesystem
description: ...
tools:
...
def build_skill_prompt(selected_skills: list[SkillSpec]) -> str:
    """
    Build an ephemeral system prompt from selected skills.
    This prompt is sent with each request but not stored in managed context.
    """
